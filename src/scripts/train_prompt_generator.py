...
def train_prompt_generator(trial, tokenizer, regression_head, prompt_generator, train_dataset):
...
def objective(trial, tokenizer, regression_head, prompt_generator, train_dataset):
    """Optuna objective function for hyperparameter tuning."""
    return train_prompt_generator(trial, tokenizer, regression_head, prompt_generator, train_dataset)

if __name__ == "__main__":
    tokenizer, regression_head, prompt_generator = load_models()
    ...
    study.optimize(
        lambda trial: objective(trial, tokenizer, regression_head, prompt_generator, train_dataset), 
        n_trials=10)
