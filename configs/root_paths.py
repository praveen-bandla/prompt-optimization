...
PROMPT_VARIATION_MODEL = os.path.join(MODELS_PATH, 'DEEPSEK-R1-PLACEHOLDER')
PROMPT_VARIATION_MODEL_INPUT = os.path.join(MODEL_INPUT_PATH, 'prompt_variation_input.txt')
