...
def load_model():
    ...
    base_prompt_model_id = "mistralai/Mistral-7B-Instruct-v0.1"
...
def base_prompt_inference(): 
    ...
    try:
        ...
        json_array = json.loads(json_match.group(0))  # Parse the JSON array
        print("Extracted Prompts:", json_array)
        return json_array
